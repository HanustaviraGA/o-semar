              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <?php
                      $sqlSurat = "SELECT * FROM surat";
                      $querySurat = mysqli_query($koneksi,$sqlSurat);
                    ?>
                    <tbody>
                      <?php while($dataSurat = mysqli_fetch_array($querySurat)):?>
                        <tr>
                          <td><?= $dataSurat['nama_pengaju'] ?></td>
                          <td><?= $dataSurat['jenis_surat'] ?></td>
                          <td><?= $dataSurat['dokumen'] ?></td>
                          <td><?= $dataSurat['tanggal_pengajuan'] ?></td>
                          <td>
                            <a href="detail.php?id=<?= $dataSurat['id'] ?>">
